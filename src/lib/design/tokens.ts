...
export const TYPE = {
  ...
  title1:
    "text-[length:var(--text-title-1)] leading-[var(--leading-title)] tracking-[var(--tracking-tight)] font-semibold",
  ...
  caption:
    "text-[length:var(--text-caption)] leading-[var(--leading-body)] text-[color:var(--color-text-secondary)]",
  micro:
    "text-[length:var(--text-micro)] tracking-[var(--tracking-caps)] uppercase font-medium text-[color:var(--color-text-tertiary)]",
} as const;
