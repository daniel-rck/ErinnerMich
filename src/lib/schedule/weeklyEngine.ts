...
export function nextWeeklyOccurrence(schedule: WeeklySchedule, from: Date): Date {
...
export function nextBiweeklyOccurrence(schedule: BiweeklySchedule, from: Date): Date {
  if (schedule.days.length === 0) {
