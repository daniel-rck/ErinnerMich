...
const NEUTRAL_SELECTED = 'bg-[color:var(--color-brand-600)] text-[color:var(--color-text-on-brand)] border-transparent'
const NEUTRAL_IDLE =
...
const TONE: Record<ChipTone, { selected: string; idle: string }> = {
  ...
  brand: {
    selected: 'bg-[color:var(--color-brand-600)] text-[color:var(--color-text-on-brand)] border-transparent',
    idle: 'bg-[color:var(--color-brand-50)] text-[color:var(--color-brand-700)] border-transparent hover:bg-[color:var(--color-brand-100)]',
  },
  success: {
    selected: 'bg-[color:var(--color-success)] text-[color:var(--color-text-on-brand)] border-transparent',
    idle: 'bg-[color:var(--color-success-soft)] text-[color:var(--color-success)] border-transparent',
  },
  warning: {
    selected: 'bg-[color:var(--color-warning)] text-[color:var(--color-text-on-brand)] border-transparent',
    idle: 'bg-[color:var(--color-warning-soft)] text-[color:var(--color-warning)] border-transparent',
  },
  danger: {
    selected: 'bg-[color:var(--color-danger)] text-[color:var(--color-text-on-brand)] border-transparent',
    idle: 'bg-[color:var(--color-danger-soft)] text-[color:var(--color-danger)] border-transparent',
  },
  info: {
    selected: 'bg-[color:var(--color-info)] text-[color:var(--color-text-on-brand)] border-transparent',
...
export const Chip = forwardRef<HTMLButtonElement, ChipProps>(function Chip(
  ...
  const sizing = size === 'sm' ? 'h-7 px-2.5 text-[length:var(--text-micro)]' : 'h-9 px-3 text-[length:var(--text-caption)]'
