...
export function EmptyState({
  ...
  return (
    <div
      className={[
        "flex flex-col items-center justify-center gap-[1rem] py-[3rem] text-center",
        className,
      ].join(" ")}
    >
      {illustration ? (
      ...
      <div className="flex flex-col gap-[0.25rem]">
        <h3 className="text-[length:1.25rem] font-semibold text-[color:var(--color-fg)]">
          {title}
        </h3>
        {description && (
          <p className="max-w-sm text-[length:0.9375rem] text-[color:var(--color-fg-muted)]">
            {description}
          </p>
        )}
      </div>
